...
class RelPersonApplicationGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the RelPersonApplication entity")
        ...
        .repeat(2) {
            ...
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "oauthAccessToken":"SAMPLE_TEXT", "dateReleased":"2020-01-01T00:00:00.000Z", "dateDenied":"2020-01-01T00:00:00.000Z", "valid":null, "denied":null, "errorDescription":"SAMPLE_TEXT", "notified":null}""")).asJSON
            .check(status.is(201))
