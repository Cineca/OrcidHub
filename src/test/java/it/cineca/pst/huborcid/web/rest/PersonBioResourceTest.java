...
@WebAppConfiguration
@IntegrationTest
public class PersonBioResourceTest {

    private static final String DEFAULT_BIOGRAPHY = "SAMPLE_TEXT";
    private static final String UPDATED_BIOGRAPHY = "UPDATED_TEXT";
    private static final String DEFAULT_RESEARCHER_URLS = "SAMPLE_TEXT";
    private static final String UPDATED_RESEARCHER_URLS = "UPDATED_TEXT";
    private static final String DEFAULT_EXTERNAL_IDENTIFIERS = "SAMPLE_TEXT";
    private static final String UPDATED_EXTERNAL_IDENTIFIERS = "UPDATED_TEXT";
    ...
    public void setup() {
        ...
        this.restPersonBioMockMvc = MockMvcBuilders.standaloneSetup(personBioResource).build();
    }
